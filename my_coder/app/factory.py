...
def build_agent(session: Session, args, ui_state: dict, hooks=None) -> Agent:
    ...
    prompt.section('discipline', 10, (
        ...
        'across shells — then clean up after yourself and delete the temporary files, '
        'logs and generated output you created, because scratch you leave behind makes '
        'the user sort out your mess before they can read the real diff. '
